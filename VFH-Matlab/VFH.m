...
%  figure(2)
%  plot(1:length(Dis1),Dis1,'r')
%  hold on
%  plot(1:length(Dis1),Dis2,'g')
%  hold on
%  plot(1:length(Dis1),Dis3,'b')
...
hold on
plot(angle_value,1,'r*','Linewidth',10)
